...
class _AdminDashboardState extends State<AdminDashboard> {
        ...
        Padding(
          ...
          child: Row(
            children: [
              DropdownButton<String>(
                value: 'Tous',
                items: ['Tous', 'Mathématiques', 'Informatique', 'Physique', 'Langues']
                    .map((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: CircleAvatar(
                          backgroundColor: _getInteractionTypeColor(interaction['type']),
                          child: Icon(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSwitchSettingsItem(
                    ...
                    subtitle: 'Permettre aux nouveaux utilisateurs de s\'inscrire',
                  ...
                  _buildSwitchSettingsItem(
                    ...
                    subtitle: 'Exiger une validation par email lors de l\'inscription',
                    icon: Icons.email,
                    value: true,
                    onChanged: (value) {
                  ...
                  _buildSwitchSettingsItem(
                    ...
                    subtitle: 'Les nouveaux comptes doivent être approuvés par un administrateur',
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSwitchSettingsItem(
                    ...
                    subtitle: 'Exiger l\'authentification à deux facteurs pour tous les utilisateurs',
                    icon: Icons.security,
                    value: false,
                    onChanged: (value) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              if (titleController.text.isNotEmpty && teacherController.text.isNotEmpty) {
                // Ajouter le cours
                setState(() {
                  _courses.add({
  ...
  void _showEditCourseDialog(Map<String, dynamic> course) {
    final TextEditingController titleController = TextEditingController(text: course['title']);
    final TextEditingController teacherController = TextEditingController(text: course['teacher']);
  ...
  void _showDeleteCourseDialog(Map<String, dynamic> course) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('Êtes-vous sûr de vouloir supprimer le cours ${course['title']}?'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Annuler'),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Politique de mot de passe modifiée avec succès!'),
                  backgroundColor: AppTheme.successColor,
                ),
              );
            },
